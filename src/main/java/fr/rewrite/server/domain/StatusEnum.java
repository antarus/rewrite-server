...
public enum StatusEnum {
  ...
  public boolean canTransitionTo(StatusEnum nextState) {
    return switch (this) {
      ...
      case REPOSITORY_CLONED, BUILD -> Set.of(BRANCH_CREATING, BUILDING, CLASSPATH_GETTING).contains(nextState);
      case CLASSPATH, UPDATED -> Set.of(BRANCH_CREATING, BUILDING, CLASSPATH_GETTING, UPDATING).contains(nextState);
      case REPOSITORY_CLONE_FAILED -> Set.of(REPOSITORY_CLONING, REPOSITORY_DELETING).contains(nextState);
      case REPOSITORY_DELETING -> Set.of(REPOSITORY_DELETED, REPOSITORY_DELETE_FAILED).contains(nextState);
      ...
      case UPDATING -> Set.of(UPDATED, UPDATE_FAILED).contains(nextState);
      case REPOSITORY_DELETE_FAILED, BRANCH_CREATION_FAILED, BUILD_FAILED, CLASSPATH_FAILED, DATASTORE_FAILED, UPDATE_FAILED -> false;
    };
  }
}
