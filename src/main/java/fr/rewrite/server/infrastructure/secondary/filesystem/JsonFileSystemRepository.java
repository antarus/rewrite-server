...
public class JsonFileSystemRepository implements DataRepository {
  ...
  public JsonFileSystemRepository(RewriteConfig rewriteConfig) {
    ...
    try {
      ...
      throw RewriteException.technicalError("Error when initilize base directory in JsonFileSystemRepository", e);
    }
