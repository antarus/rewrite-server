...
class DatastoreCreatorTest {
    ...
    void constructor_shouldThrowExceptionWhenRewriteConfigIsNull() {
        assertThrows(
                ...
                () -> new DatastoreCreator(null, mockDatastorePort, mockEventBusPort)
        );
    }
    ...
    void constructor_shouldThrowExceptionWhenDatastorePortIsNull() {
        assertThrows(
                MissingMandatoryValueException.class,
                () -> new DatastoreCreator(mockRewriteConfig, null, mockEventBusPort)
        );
    }
    ...
    void constructor_shouldThrowExceptionWhenEventBusIsNull() {
        assertThrows(
                MissingMandatoryValueException.class,
                () -> new DatastoreCreator(mockRewriteConfig, mockDatastorePort, null)
        );
    }
