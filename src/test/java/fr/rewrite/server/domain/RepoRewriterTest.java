...
class RepoRewriterTest {
    ...
    void constructor_shouldThrowExceptionWhenRewriteConfigIsNull() {
        assertThrows(
                ...
                () -> new RepoRewriter(null, mockJobPort, mockEventBusPort, mockDataRepository)
        );
    }
    ...
    void constructor_shouldThrowExceptionWhenEventBusIsNull() {
        assertThrows(
                MissingMandatoryValueException.class,
                () -> new RepoRewriter(mockRewriteConfig, mockJobPort, null, mockDataRepository)
        );
    }
    ...
    void constructor_shouldThrowExceptionWhenDataRepositoryIsNull() {
        assertThrows(
                MissingMandatoryValueException.class,
                () -> new RepoRewriter(mockRewriteConfig, mockJobPort, mockEventBusPort, null)
        );
    }
